...
| 群組設定 | `!設定球隊 XX羽球隊` | 設定群組球隊名稱 |
| 群組設定 | `!設定場館 K01` | 設定群組預設場館 |
| 群組設定 | `!設定時間 20-22` | 設定群組預設時間 |
| 群組設定 | `!設定截止 2` | 設定統計截止為活動日前 X 天 |
| 群組設定 | `!設定人數 6` | 設定最低成團人數 |
| 查詢設定 | `!查詢設定` | 檢視目前群組的預設值 |
| 重置設定 | `!重置設定` | 將預設值重設為 K00、20-22、2、4 |
